...
parser.add_argument('--schedule-file', default='/content/sparse_learning/imagenet/baseline/learning_schedules/wrnet_schedule.yaml', type=str,
...
def main():
    ...
    with open(args.schedule_file, 'r') as stream:
        try:
            loaded_schedule = yaml.safe_load(stream)
